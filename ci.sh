...
if [[ -z ${CI_OPT_ORIGIN_REPO_SLUG+x} ]]; then if [[ -n "${CI_PROJECT_PATH}" ]]; then CI_OPT_ORIGIN_REPO_SLUG="gitlab-cloud-ready/cloud-ready-parent"; else CI_OPT_ORIGIN_REPO_SLUG="cloud-ready/cloud-ready-parent"; fi; fi
